-- Migration Script: Fix breathing_activity RLS policy
-- Run this in your Supabase SQL Editor to fix the breathing activity duplicate issue
...
-- Clean up any existing 0-duration completed activities (optional)
-- Uncomment the following lines if you want to clean up existing bad data:

-- DELETE FROM breathing_activity 
-- WHERE duration_seconds = 0 AND completed = true; 